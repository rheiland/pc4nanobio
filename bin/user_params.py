...
class UserTab(object):
    ...
    def __init__(self):
        ...
        units_button16 = Button(description='micron/min', disabled=True, layout=units_button_layout) 
        ...
        units_button34 = Button(description='mmHg', disabled=True, layout=units_button_layout) 
        units_button34.style.button_color = 'tan'
        units_button35 = Button(description='mmHg', disabled=True, layout=units_button_layout) 
        units_button35.style.button_color = 'lightgreen'
        units_button36 = Button(description='mmHg', disabled=True, layout=units_button_layout) 
        ...
        units_button45 = Button(description='micron/min', disabled=True, layout=units_button_layout) 
        units_button45.style.button_color = 'lightgreen'
        units_button46 = Button(description='min', disabled=True, layout=units_button_layout) 
        ...
        row4 = [param_name4, self.max_birth_rate, units_button4, desc_button4] 
        row5 = [param_name5, self.o2_proliferation_saturation, units_button5, desc_button5] 
        row6 = [param_name6, self.o2_proliferation_threshold, units_button6, desc_button6] 
        row7 = [param_name7, self.o2_reference, units_button7, desc_button7] 
        row8 = [param_name8, self.max_necrosis_rate, units_button8, desc_button8] 
        row9 = [param_name9, self.o2_necrosis_threshold, units_button9, desc_button9] 
        row10 = [param_name10, self.o2_necrosis_max, units_button10, desc_button10] 
        row11 = [param_name11, self.apoptosis_rate, units_button11, desc_button11] 
        row12 = [param_name12, self.is_motile, units_button12, desc_button12] 
        row13 = [param_name13, self.bias, units_button13, desc_button13] 
        row14 = [param_name14, self.gradient_substrate_index, units_button14, desc_button14] 
        row15 = [param_name15, self.negative_taxis, units_button15, desc_button15] 
        row16 = [param_name16, self.speed, units_button16, desc_button16] 
        row17 = [param_name17, self.persistence_time, units_button17, desc_button17] 
        row18 = [param_name18, self.max_relative_adhesion_distance, units_button18, desc_button18] 
        row19 = [param_name19, self.adhesion_strength, units_button19, desc_button19] 
        row20 = [param_name20, self.repulsion_strength, units_button20, desc_button20] 
        row21 = [param_name21, self.effect_model, units_button21, desc_button21] 
        row22 = [param_name22, self.EC_50, units_button22, desc_button22] 
        row23 = [param_name23, self.Hill_power, units_button23, desc_button23] 
        row24 = [param_name24, self.enable_active_influx, units_button24, desc_button24] 
        row25 = [param_name25, self.relative_max_internal_concentration, units_button25, desc_button25] 
        row26 = [param_name26, self.internalization_rate, units_button26, desc_button26] 
        row27 = [param_name27, self.reference_external_concentration, units_button27, desc_button27] 
        row28 = [param_name28, self.cycle, units_button28, desc_button28] 
        row29 = [param_name29, self.apoptosis, units_button29, desc_button29] 
        row30 = [param_name30, self.motility, units_button30, desc_button30] 
        row31 = [param_name31, self.mechanics, units_button31, desc_button31] 
        row32 = [param_name32, self.secretion, units_button32, desc_button32] 
        row33 = [param_name33, self.treat_max_birth_rate, units_button33, desc_button33] 
        row34 = [param_name34, self.treat_o2_proliferation_saturation, units_button34, desc_button34] 
        row35 = [param_name35, self.treat_o2_proliferation_threshold, units_button35, desc_button35] 
        row36 = [param_name36, self.treat_o2_reference, units_button36, desc_button36] 
        row37 = [param_name37, self.treat_max_necrosis_rate, units_button37, desc_button37] 
        row38 = [param_name38, self.treat_o2_necrosis_threshold, units_button38, desc_button38] 
        row39 = [param_name39, self.treat_o2_necrosis_max, units_button39, desc_button39] 
        row40 = [param_name40, self.treat_apoptosis_rate, units_button40, desc_button40] 
        row41 = [param_name41, self.treat_is_motile, units_button41, desc_button41] 
        row42 = [param_name42, self.treat_bias, units_button42, desc_button42] 
        row43 = [param_name43, self.treat_gradient_substrate_index, units_button43, desc_button43] 
        row44 = [param_name44, self.treat_negative_taxis, units_button44, desc_button44] 
        row45 = [param_name45, self.treat_speed, units_button45, desc_button45] 
        row46 = [param_name46, self.treat_persistence_time, units_button46, desc_button46] 
        row47 = [param_name47, self.treat_max_relative_adhesion_distance, units_button47, desc_button47] 
        row48 = [param_name48, self.treat_adhesion_strength, units_button48, desc_button48] 
        row49 = [param_name49, self.treat_repulsion_strength, units_button49, desc_button49] 
        row50 = [param_name50, self.treat_oxygen_uptake_rate, units_button50, desc_button50] 
